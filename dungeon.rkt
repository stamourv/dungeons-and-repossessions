...
(define (add-room! grid start-pos height width)
  (define-values (free-cells extension-points)
    (for*/fold ([free-cells       '()]
      ...
      (define (add-wall!) (array-set! grid pos (new raw-wall%)))

...
(make-encounter 1 'hard (new bat%) (new bat%))

(define-simple-monster rat% #\r "rat" 1 10) ; TODO 1 -> (max 1d4-1 1)
(make-encounter 1 'easy (new rat%))
(make-encounter 1 'hard (new rat%) (new rat%))
(make-encounter 1 'deadly (new rat%) (new rat%) (new rat%))
...
(make-encounter 1 'medium (new giant-rat%))
(make-encounter 1 'deadly (new giant-rat%) (new rat%))

(define-simple-monster kobold% #\k "kobold" 5 25) ; TODO 5 -> 2d6 - 2
(make-encounter 1 'medium (new kobold%))
(make-encounter 1 'deadly (new kobold%) (new spider%))
